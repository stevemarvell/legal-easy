...
@router.get(
    ...
    summary="Get AI-powered case assessment",
    description="""
    Generate an AI-powered assessment of a legal case using the appropriate playbook.
    
    This endpoint applies case type-specific playbook rules to analyze the case and provides:
    - Case strength evaluation (Strong, Moderate, Weak)
    - Key legal issues identified
    - Recommended actions based on playbook rules
    - Monetary assessment range
    - Applied playbook rules and reasoning
    
    The assessment is generated by:
    ...
    4. Generating tailored recommendations
    ...
    **Use cases:**
    ...
    responses={
        200: {
            "description": "Case assessment generated successfully",
            "content": {
                "application/json": {
                    "example": {
                        "case_id": "case-001",
...
async def get_case_assessment(
    case_id: str = Path(..., description="Unique identifier of the case to assess", example="case-001")
):
    ...
    try:
        ...
        # Generate assessment using playbook engine
        assessment = playbook_engine.generate_case_assessment(case)
